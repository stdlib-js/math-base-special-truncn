...
tape( 'the function supports rounding a numeric value to a desired number of decimals', function test( t ) {
	t.strictEqual( truncn( PI, -4 ), 3.1415, 'equals 3.1415' );
	t.strictEqual( truncn( -PI, -2 ), -3.14, 'equals -3.14' );
	t.strictEqual( truncn( 9.99999, -2 ), 9.99, 'equals 9.99' );
	t.strictEqual( truncn( -9.99999, -2 ), -9.99, 'equals -9.99' );
	t.strictEqual( truncn( 0.0, 2 ), 0.0, 'equals 0' );
	t.strictEqual( truncn( 12368.0, -3 ), 12368.0, 'equals 12368' );
	t.strictEqual( truncn( -12368.0, -3 ), -12368.0, 'equals -12368' );
	t.end();
});

tape( 'the function supports rounding a numeric value to a desired number of digits', function test( t ) {
	t.strictEqual( truncn( PI, 4 ), 0.0, 'equals 0' );
	t.strictEqual( truncn( 12368.0, 3 ), 12000.0, 'equals 12000' );
	t.strictEqual( truncn( 12363.0, 1 ), 12360.0, 'equals 12360' );
	t.strictEqual( isPositiveZero( truncn( PI, 3 ) ), true, 'equals +0' );
	t.strictEqual( truncn( -12368.0, 3 ), -12000.0, 'equals -12000' );
	t.strictEqual( truncn( -12368.0, 1 ), -12360.0, 'equals -12360' );
	t.end();
});
...
tape( 'if `n > 308` and `x < 0`, the function returns `-0`', function test( t ) {
	var exp;
	var x;
	var n;
	var v;
